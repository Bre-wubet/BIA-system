...
export const createDataSource = async (dataSourceData) => {
    try {
        const response = await axios.post(apiPaths.CREATE_DATA_SOURCE, dataSourceData);
...
export const getAllDataSources = async (params = {}) => {
    try {
        const response = await axios.get(apiPaths.GET_ALL_DATA_SOURCES, { params });
        return response.data;
    } catch (error) {
...
export const getDataSourceTypes = async () => {
    try {
        const response = await axios.get(apiPaths.GET_DATA_SOURCE_TYPES);
        return response.data;
    } catch (error) {
...
export const getActiveDataSources = async () => {
    try {
        const response = await axios.get(apiPaths.GET_ACTIVE_DATA_SOURCES);
        return response.data;
    } catch (error) {
...
export const getDataSource = async (id) => {
    try {
        const response = await axios.get(apiPaths.GET_DATA_SOURCE_BY_ID(id));
        return response.data;
    } catch (error) {
...
export const updateDataSource = async (id, updateData) => {
    try {
        const response = await axios.put(apiPaths.UPDATE_DATA_SOURCE(id), updateData);
        return response.data;
    } catch (error) {
...
export const updateDataSourceStatus = async (id, status) => {
    try {
        const response = await axios.put(apiPaths.UPDATE_DATA_SOURCE_STATUS(id), { status });
        return response.data;
    } catch (error) {
...
export const deleteDataSource = async (id) => {
    try {
        const response = await axios.delete(apiPaths.DELETE_DATA_SOURCE(id));
        return response.data;
    } catch (error) {
...
export const softDeleteDataSource = async (id) => {
    try {
        const response = await axios.delete(apiPaths.SOFT_DELETE_DATA_SOURCE(id));
        return response.data;
    } catch (error) {
...
export const getDataSourcesByModuleAndType = async (moduleName = "", dataSourceType = "") => {
  try {
    const response = await axios.get(`${BASE_URL}/api/data-source`, {
      params: {
...
export const testConnection = async (id) => {
    try {
        const response = await axios.post(apiPaths.TEST_CONNECTION_BY_ID(id));
        return response.data;
    } catch (error) {
...
export const syncDataSource = async (id, options = {}) => {
    try {
        const response = await axios.post(apiPaths.SYNC_DATA_SOURCE(id), options);
        return response.data;
    } catch (error) {
...
export const getSyncQueue = async () => {
    try {
        const response = await axios.get(apiPaths.GET_SYNC_QUEUE);
        return response.data;
    } catch (error) {
...
export const getIntegrationLogs = async () => {
    try {
        const response = await axios.get(apiPaths.GET_SYNC_LOGS);
        return response.data;
    } catch (error) {
...
export const getDataSyncHistoryByDataSourceId = async (dataSourceId) => {
    try {
        const response = await axios.get(apiPaths.GET_SYNC_LOGS_BY_ID(dataSourceId));
        return response.data;
    } catch (error) {
...
export const getPaginatedIntegrationLogs = async (page = 1, limit = 10, filters = {}) => {
    try {
        ...
        const response = await axios.get(apiPaths.GET_SYNC_LOGS_PAGINATED, { params });
        return response.data;
    } catch (error) {
...
export const syncMultipleDataSources = async (ids) => {
    try {
        const response = await axios.post(apiPaths.SYNC_MULTIPLE_DATA_SOURCES, { dataSourceIds: ids });
        return response.data;
    } catch (error) {
...
export const testMultipleConnections = async (dataSourceIds) => {
    try {
        const response = await axios.post(apiPaths.TEST_MULTIPLE_CONNECTIONS, { dataSourceIds });
        return response.data;
    } catch (error) {
...
export const getMappingRules = async (dataSourceId) => {
    try {
        const response = await axios.get(apiPaths.GET_RULES(dataSourceId));
        return response.data;
    } catch (error) {
...
export const addMappingRule = async (dataSourceId, ruleData) => {
    try {
        const response = await axios.post(apiPaths.ADD_RULE(dataSourceId), ruleData);
        return response.data;
    } catch (error) {
...
export const updateMappingRule = async (dataSourceId, mapId, ruleData) => {
    try {
        const response = await axios.put(apiPaths.UPDATE_RULE(dataSourceId, mapId), ruleData);
        return response.data;
    } catch (error) {
...
export const deleteMappingRule = async (dataSourceId, mapId) => {
    try {
        const response = await axios.delete(apiPaths.DELETE_RULE(dataSourceId, mapId));
        return response.data;
    } catch (error) {
