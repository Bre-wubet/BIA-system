...
const ExportScheduler = ({ exportItem, onSchedule, onCancel }) => {
  const [scheduleData, setScheduleData] = useState({
    frequency: exportItem?.schedule_config?.frequency || 'daily',
    time: exportItem?.schedule_config?.time || '09:00',
    dayOfWeek: exportItem?.schedule_config?.dayOfWeek || 'monday',
    dayOfMonth: exportItem?.schedule_config?.dayOfMonth || 1,
    recipients: exportItem?.schedule_config?.recipients || '',
    format: exportItem?.schedule_config?.format || exportItem?.format || 'csv',
    timezone: exportItem?.schedule_config?.timezone || 'UTC',
    enabled: exportItem?.is_scheduled || false
  });
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="text-sm text-blue-800">
              ...
              <div><strong>Format:</strong> {scheduleData.format.toUpperCase()}</div>
      ...
      <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
        ...
        <Button
          ...
          variant="primary"
        >
          {exportItem?.is_scheduled ? 'Update Schedule' : 'Create Schedule'}
        </Button>
      </div>
    </form>
  );
