...
// (10,'Nile Pharma Distributors', 4.3, 'active',   '963 Health Park, Khartoum, Sudan');
    ...
    await database.query(`
      ...
      INSERT INTO purchase_orders (supplier_id, created_at, total_amount, status) VALUES
      (1, '2025-09-01', 2500.00, 'Approved'),
      (2, '2025-09-03', 1400.00, 'Pending'),
      (3, '2025-09-05', 3200.00, 'Received');
    ...
    // await database.query(`
    //   INSERT INTO dim_products (product_id, name, sku, category, unit, product_type) VALUES
    //   (1, 'Laptop Pro 15', 'LP-15', 'Electronics', 'pcs', 'salable'),
    //   (2, 'Steel Rod', 'SR-10', 'Construction', 'kg', 'storable'),
    //   (3, 'Printer Ink', 'INK-001', 'Office Supplies', 'bottle', 'consumable')
    //   ON CONFLICT (product_id) DO NOTHING;
      
    //   INSERT INTO dim_suppliers (supplier_id, name, rating, status, address) VALUES
    //   (101, 'Tech World Ltd.', 5, 'active', 'Addis Ababa'),
    //   (102, 'SteelCo PLC', 4, 'active', 'Nairobi'),
    //   (103, 'Office Supplies Inc.', 3, 'inactive', 'Dubai')
    ...
    //   (601, 101, '2025-01-01', '2025-12-31', 'active'),
    //   (602, 102, '2025-06-01', '2026-05-31', 'active')
    //   ON CONFLICT (contract_id) DO NOTHING;
    // `);

    // // 3. Seed Fact Tables
    // await database.query(`
    //   INSERT INTO fact_procurement (po_id, product_id, supplier_id, date_id, quantity, unit_price, subtotal, total_amount, status) VALUES
    //   (10001, 1, 101, 1001, 10, 1200.00, 12000.00, 12000.00, 'approved'),
    //   (10002, 2, 102, 1001, 500, 5.00, 2500.00, 2500.00, 'pending'),
    //   (10001, 1, 101, 1001, 10, 1200.00, 12000.00, 12000.00, 'approved'),
    //   (10002, 2, 102, 1001, 500, 5.00, 2500.00, 2500.00, 'pending'),
    //   (10001, 1, 101, 1001, 10, 1200.00, 12000.00, 12000.00, 'approved'),
    //   (10002, 2, 102, 1001, 500, 5.00, 2500.00, 2500.00, 'pending'),
    ...
    //   INSERT INTO fact_goods_receipt (grn_id, po_id, product_id, warehouse_id, date_id, quantity_received, condition) VALUES
    ...
    //   (30001, 10001, 101, 1002, 12000.00, 600.00, 6000.00, 'partially_paid'),
    //   (30002, 10002, 102, 1002, 2500.00, 125.00, 2500.00, 'paid'),
    //   (30001, 10001, 101, 1002, 12000.00, 600.00, 6000.00, 'partially_paid'),
    //   (30002, 10002, 102, 1002, 2500.00, 125.00, 2500.00, 'paid');

    //   INSERT INTO fact_inventory (product_id, warehouse_id, date_id, quantity, cost, total_value) VALUES
    //   (1, 201, 1002, 50, 1200.00, 60000.00),
    //   (2, 202, 1002, 200, 5.00, 1000.00),
    //   (1, 201, 1002, 50, 1200.00, 60000.00),
    //   (2, 202, 1002, 200, 5.00, 1000.00);

    //   INSERT INTO stock_transfer (transfer_id, product_id, from_warehouse_id, to_warehouse_id, date_id, quantity_transferred, status) VALUES
    ...
    //   INSERT INTO fact_distribution (order_id, distributor_id, product_id, logistics_provider_id, date_id, quantity, delivery_status, fulfillment_method) VALUES
